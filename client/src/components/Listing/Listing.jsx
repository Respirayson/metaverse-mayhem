    ...
    <div className='sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer'>
        ...
        <div className='flex flex-col p-4'>
            <div className='flex flex-row items-center mb-[18px]'>
             <p className='ml-[12px] mt-[2px] font-medium text-[12px] text-[#808191]'>Category: {minion}</p> 
            </div>
            ...
            <div className='flex flex-wrap justify-between gap-2 mt-[15px]'>
                <div className='flex flex-col'>
                    <h4 className='font-semibold text-[14px] text-[#b2b3bd] leading-[22px]'>Price: {price}</h4>
